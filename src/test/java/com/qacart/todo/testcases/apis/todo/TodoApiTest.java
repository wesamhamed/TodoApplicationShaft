...
public class TodoApiTest {
    ...
    public void shouldBeAbleToAddTodo(){
        ...
        Response response = todoSteps.addTodo(addTodoRequest,token,201);
    ...
    public void shouldNotBeAbleToAddTodoIfIsCompletedMissing(){
        ...
        Response response = todoSteps.addTodo(addTodoRequest,token,400);
    ...
    public void shouldBeAbleToGetATodoByID(){
        ...
        Response getTodoResponse = todoSteps.getTodoByID(token,addTodoResponse.getId(),200);
    ...
    public void shouldBeAbleToDeleteTodoByID(){
        ...
        TodoSteps todoSteps = new TodoSteps();
        AddTodoRequestBody addTodoRequest = todoSteps.generateTodo();
        AddTodoResponseBody addTodoResponse = todoSteps.addTodo(addTodoRequest,token,201)
                .body().as(AddTodoResponseBody.class);

        String todoID = addTodoResponse.getId();
        Response deleteTodoResponse = todoSteps.deleteTodoByID(token,todoID,200);
